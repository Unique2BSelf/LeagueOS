          ...
          <div className="flex items-center gap-2">
            <Link href="/" className="flex items-center gap-2">
              <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-[#00F5FF] to-[#00B8FF] flex items-center justify-center">
                <svg className="w-5 h-5 text-[#121212]" fill="currentColor" viewBox="0 0 20 20"><path d="M10 2a8 8 0 100 16 8 8 0 000-16zM4.5 10a5.5 5.5 0 1111 0 5.5 5.5 0 01-11 0z"/></svg>
              </div>
          ...
          <div className="flex items-center gap-3">
            {user ? (
              <>
                ...
                <button onClick={handleLogout} className="hidden md:flex items-center gap-2 text-[#AAAAAA] hover:text-red-400 transition-colors text-sm">
                  <LogOut size={18} />
                  Logout
                </button>
              </>
            ...
            <button className="md:hidden text-[#AAAAAA]" onClick={() => setMobileMenuOpen(!mobileMenuOpen)}>
